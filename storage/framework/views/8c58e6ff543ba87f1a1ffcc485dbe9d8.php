...
<body>
    ...
    <div class="seccion">
        ...
        <table class="table">
            ...
            <tbody>
                <tr>
                    <td class="center"><?php echo e((int) data_get($totales,'pendientes',0)); ?></td>
                    <td class="center"><?php echo e((int) data_get($totales,'aprobados',0)); ?></td>
                    <td class="center"><?php echo e((int) data_get($totales,'rechazados',0)); ?></td>
                    <td class="center"><?php echo e((int) data_get($totales,'solicitados',0)); ?></td>
                    <td class="center"><?php echo e((int) ($diasAprobados ?? 0)); ?></td>
                </tr>
            </tbody>
        </table>
    </div>
    ...
    <div class="seccion">
        ...
        <?php $arr = collect($topMotivos ?? []); $maxMot = max($arr->pluck('c')->toArray() ?: [0]); ?>
        <table class="table">
            <thead>
                <tr>
                    <th>Motivo</th>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $arr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <tr>
                        <td>
                            ...
                            <div class="bar-wrap"><div class="bar" style="width: <?php echo e($pct); ?>%;"></div></div>
                        </td>
        ...
        <table class="table">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = ($detalle ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td><?php echo e(!empty($p->fecha_inicio) ? \Carbon\Carbon::parse($p->fecha_inicio)->format('d/m/Y') : '—'); ?></td>
                        <td><?php echo e(!empty($p->fecha_fin) ? \Carbon\Carbon::parse($p->fecha_fin)->format('d/m/Y') : '—'); ?></td>
                        <td><?php echo e(optional($p->personal)->nombre_completo ?? '—'); ?></td>
                        <td><?php echo e(!empty($p->tipo) ? ucfirst($p->tipo) : '—'); ?></td>
                        <td><?php echo e(!empty($p->estado) ? ucfirst($p->estado) : '—'); ?></td>
...
<?php /**PATH C:\xampp\htdocs\Laravel\Proyecto_MPGFil\resources\views/pdf/permisos-personal-mensual.blade.php ENDPATH**/ ?>