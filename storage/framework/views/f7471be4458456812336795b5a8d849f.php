            ...
            <tbody>
                <?php $__currentLoopData = $personal->asistencias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $asistencia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td><?php echo e($asistencia->hora_salida?->format('H:i') ?? '—'); ?></td>
...
<?php /**PATH C:\xampp\htdocs\Laravel\Proyecto_MPGFil\resources\views/pdf/ficha-personal-mensual.blade.php ENDPATH**/ ?>