...
<body>
    <div class="logo"><img src="<?php echo e(public_path('images/LogosMPG/Recurso 3.png')); ?>" alt="MaxPowerGym"></div>
    ...
    <div class="seccion">
        ...
        <div class="kpis">
            <div class="kpi">
                ...
                <div class="val"><?php echo e($kpis['total']); ?></div>
            </div>
            <div class="kpi">
                <div class="label">Disponibles</div>
                <div class="val"><?php echo e($kpis['disponibles']); ?></div>
            </div>
            <div class="kpi">
                <div class="label">Ocupados</div>
                <div class="val"><?php echo e($kpis['ocupados']); ?></div>
            </div>
            <div class="kpi">
                <div class="label">Mantenimiento</div>
                <div class="val"><?php echo e($kpis['mantenimiento']); ?></div>
            </div>
            <div class="kpi">
                <div class="label">Vencidos</div>
                <div class="val"><?php echo e($kpis['vencidos']); ?></div>
            </div>
        </div>
        <div class="kpis" style="margin-top:6px">
            <div class="kpi">
                <div class="label">Ingresos Mensualidad</div>
                <div class="val">Bs <?php echo e(number_format($kpis['ingresos_mensual'], 2)); ?></div>
            </div>
            <div class="kpi">
                <div class="label">Ingresos Reposiciones</div>
                <div class="val">Bs <?php echo e(number_format($kpis['ingresos_repos'], 2)); ?></div>
            </div>
            <div class="kpi">
                <div class="label">Ingresos Totales</div>
                <div class="val">Bs <?php echo e(number_format($kpis['ingresos_totales'], 2)); ?></div>
            </div>
            <div class="kpi">
                <div class="label">Próx. a vencer (7d)</div>
                <div class="val"><?php echo e($kpis['proximos_vencer_7d']); ?></div>
            </div>
            <div class="kpi">
                <div class="label">&nbsp;</div>
                <div class="val">&nbsp;</div>
    ...
    <div class="seccion">
        ...
        <table class="table">
            ...
            <tbody>
                <?php $map = ['disponible' => 'Disponible', 'ocupado' => 'Ocupado', 'mantenimiento' => 'Mantenimiento']; ?>
                <?php $__empty_1 = true; $__currentLoopData = $porEstado; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $estado => $cant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td><?php echo e($map[$estado] ?? ucfirst($estado)); ?></td>
    ...
    <div class="seccion">
        ...
        <table class="table">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $metodosMensual; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td><?php echo e(strtoupper($m->metodo_pago ?? '—')); ?></td>
                        <td class="center"><?php echo e((int) $m->cantidad); ?></td>
    ...
    <div class="seccion">
        ...
        <table class="table">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $metodosRepos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td><?php echo e(strtoupper($m->metodo_pago ?? '—')); ?></td>
                        <td class="center"><?php echo e((int) $m->cantidad); ?></td>
                        <td class="right">Bs <?php echo e(number_format($m->cobrado, 2)); ?></td>
    ...
    <div class="seccion">
        ...
        <table class="table">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $detalle; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td><?php echo e($c->numero); ?></td>
                        <td><?php echo e($c->cliente ? ($c->cliente->nombre . ' ' . $c->cliente->apellido_paterno . ' ' . $c->cliente->apellido_materno) : '—'); ?>
                        ...
                        <td><?php echo e(strtoupper($c->metodo_pago_reposicion ?? '—')); ?></td>
                    </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <tr>
...
</html><?php /**PATH C:\xampp\htdocs\Laravel\Proyecto_MPGFil\resources\views/pdf/casilleros_resumen.blade.php ENDPATH**/ ?>