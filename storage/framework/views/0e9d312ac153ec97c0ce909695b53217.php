...
<?php endif; ?>
        ...
        <div <?php if($pollingInterval = $this->getPollingInterval()): ?> wire:poll.<?php echo e($pollingInterval); ?>="updateChartData"
        <?php endif; ?>>
            <div <?php if(FilamentView::hasSpaMode()): ?> x-load="visible" <?php else: ?> x-load <?php endif; ?>
                ...
                wire:ignore x-data="chart({
                        ...
                        ]); ?>" class="w-full h-[220px] max-h-[220px] overflow-hidden"></div>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\Laravel\Proyecto_MPGFil\resources\views/vendor/filament-widgets/chart-widget.blade.php ENDPATH**/ ?>