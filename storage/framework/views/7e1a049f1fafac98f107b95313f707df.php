...
<head>
    <meta charset="UTF-8">
    <title>Reporte Anual - Ingresos, Ventas y Stock</title>
    <style>
        body {
...
<body>
    ...
    <h2>Reporte Anual - Ingresos, Ventas y Stock</h2>

    <div class="seccion">
        <div class="titulo-seccion">Ingresos del Año</div>
        <table class="table">
            <thead>
                <tr>
                    <th>Producto</th>
    ...
    <div class="seccion">
        <div class="titulo-seccion">Ventas del Año</div>
        <table class="table">
            <thead>
                <tr>
                    <th>Producto</th>
    ...
    <div class="seccion">
        <div class="titulo-seccion">Control de Stock del Año</div>
        <table class="table">
            <thead>
                <tr>
                    <th>Producto</th>
            ...
            <tbody>
                <?php $__currentLoopData = $controlStock; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producto => $datos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><?php echo e($producto); ?></td>
                        <td><?php echo e($datos['inicial']); ?></td>
                        <td><?php echo e($datos['ingresado']); ?></td>
                        <td><?php echo e($datos['vendido']); ?></td>
                        <td><?php echo e($datos['final']); ?></td>
                    </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </tbody>
        </table>
...
</html><?php /**PATH C:\xampp\htdocs\Laravel\Proyecto_MPGFil\resources\views/pdf/reporte-productos-anual.blade.php ENDPATH**/ ?>